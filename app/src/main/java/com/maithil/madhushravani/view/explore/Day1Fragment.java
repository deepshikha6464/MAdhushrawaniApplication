   ...
   AdView mAdView;
    ...
    public void onClick(View view) {
        ...
        switch (id) {
            ...
            case R.id.read:
                kathaText.setVisibility(View.VISIBLE);
               readKatha.setTextColor(Color.parseColor("#D81B60"));
                listen.setTextColor(Color.parseColor("#000000"));

                break;
            case R.id.Listen:

                kathaText.setVisibility(View.GONE);
                listen.setTextColor(Color.parseColor("#D81B60"));
                readKatha.setTextColor(Color.parseColor("#000000"));
            ...
            case R.id.card1:
                ...
                miniText.setText( " Poojan  Aarambh" );
                break;
            case R.id.card2:
                poojaVidhi = "► अक्षत लय -\"नमः शांति कलश इहागच्छ यह तिष्ट \"\n" +
                        ...
                        "► फूल लय -\"पुष्पम ग्रहण सुबह यच्छ पुज्याधार नमोस्तुते \"\n" +
                        "                     ऐश पुष्पांजलिः नमः शांतिकलशयाय नमः “";
            ...
            case R.id.card7:
                ...
                cardClicked(poojaVidhi, "Kusmawati");
                break;
            case R.id.card8:
            ...
            case R.id.audioCard:
                ...
                play.setTextColor(Color.parseColor("#D81B60"));
...
//                mp = MediaPlayer.create(getActivity().getApplicationContext(), R.raw.katha_one);
                break;
            case R.id.readVacho:
                if(vachobini.getVisibility()==View.VISIBLE){
                    vachobini.setVisibility(View.GONE);
                    readVacho.setTextColor(Color.parseColor("#000000"));

                }else
                {
                readVacho.setTextColor(Color.parseColor("#D81B60"));
                vacho.setTextColor(Color.parseColor("#000000"));
                vachobini.setVisibility(View.VISIBLE);}
                   break;
    ...
    private void findViewByid(View view) {
        ...
        kathaText = view.findViewById(R.id.kathaText);
        kathaText.setOnClickListener(this);

vachobini = view.findViewById(R.id.vachobini);
readVacho = view.findViewById(R.id.readVacho); readVacho.setOnClickListener(this);
